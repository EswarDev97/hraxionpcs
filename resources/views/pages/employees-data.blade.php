        ...
        <table class="table table-light table-striped table-hover table-bordered text-center">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                  <a href="{{ route('employees-data.show', ['employee' => $employee->id]) }}">
                      {{ $employee->name ?? 'Unnamed Employee' }}
                  </a>
              </td>
              <td>{{ $employee->position ?? 'Default Position' }}</td>
              <td>{{ $employee->department->name ?? 'No Department Assigned' }}</td>
              <td>{{ $employee->start_of_contract ?? 'Not Available' }}</td>
              <td>{{ $employee->end_of_contract ?? 'Not Available' }}</td>
          </tr>
            @endforeach
          </tbody>
        </table>
