            ...
            <div class="row">
              <div class="col-sm-12 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="blood_group" id="blood_group" class="form-control @error('blood_group') is-invalid @enderror" value="{{ old('blood_group') }}" placeholder="Enter blood group">
                </div>
                @error('blood_group')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              ...
              <div class="col-sm-12 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="emergency_contact_number" id="emergency_contact_number" class="form-control @error('emergency_contact_number') is-invalid @enderror" value="{{ old('emergency_contact_number') }}" placeholder="Enter emergency contact number">
                </div>
